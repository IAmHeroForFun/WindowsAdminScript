@echo off
title Windows Shared Drive & Shared Printer Fix Suite Launcher
echo ==========================================================================
echo   OmviHub IT Toolkit - Shared Drive & USB Shared Printer Repair Suite
echo ==========================================================================
echo.
...
:RunScript
echo.
echo Launching fix_sharing.ps1...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0fix_sharing.ps1"
echo.
echo ==========================================================================
